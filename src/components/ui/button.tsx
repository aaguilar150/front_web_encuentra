  ...
  "inline-flex shrink-0 items-center justify-center font-bold whitespace-nowrap transition-all outline-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        toggleOff: 'bg-white border-2 border-amber-400 text-amber-700 hover:bg-amber-100 shadow-sm',
        toggleOn: 'bg-amber-500 border-2 border-amber-500 text-white hover:bg-amber-600 shadow-md',
        destructive: 'bg-amber-500 text-white hover:bg-amber-600 shadow-sm',
      },
      size: {
