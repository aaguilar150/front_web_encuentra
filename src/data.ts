...
export const INITIAL_FOUND_PERSONS: FoundPerson[] = [
  {
    ...
    physicalDescription:
      'Hombre de aproximadamente 35 años, contextura media, estatura 1.75m. Cicatriz en la ceja izquierda, vestía franela azul con rayas blancas y pantalón deportivo gris. Se encuentra consciente pero desorientado.',
    imageUrl:
  ...
  },
  {
    ...
    physicalDescription:
      'Joven masculino, aproximadamente 18-22 años, cabello corto negro ondulado, tez trigueña, lunar grande cerca de la oreja derecha. Vestía suéter gris oscuro de capucha y jeans negros. No recuerda su cédula ni lugar de procedencia.',
    imageUrl:
  ...
  },
  {
    ...
    physicalDescription:
      'Mujer de aprox. 28 años, cabello castaño largo liso, estatura 1.62m. Tatuaje pequeño de mariposa en la muñeca derecha. Vestía blusa verde oliva y zapatos deportivos blancos. Sufrió contusiones leves pero está estable.',
    imageUrl:
  ...
  },
  {
    ...
    physicalDescription:
      'Mujer adulta de aproximadamente 55-60 años, cabello canoso recogido, tez blanca, usa anteojos recetados con montura roja. Vestía bata de flores amarillas. Se encuentra en buen estado general pero con crisis de ansiedad.',
    imageUrl:
  ...
  },
  {
    ...
    physicalDescription:
      'Niño de aprox. 6-7 años, tez clara, ojos marrones, cabello castaño claro liso. Vestía franela roja de superhéroe y shorts de jean. Sabe que se llama Santiago pero desconoce su apellido y nombres de sus padres.',
    imageUrl:
      'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
  ...
  },
  {
    ...
    physicalDescription:
      'Niña de aprox. 9-10 años, cabello negro largo trenzado, tez morena, ojos negros. Vestía uniforme escolar azul y blanco con mochila rosada. Habla con acento llanero, menciona que viene de Apure.',
    imageUrl:
      'https://images.unsplash.com/photo-1611601322175-ef8ec8c85f01?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
